...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=../fflib --incdir=../fflib/include --disable-static --enable-shared --disable-yasm --disable-symver --enable-gpl --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-doc --disable-symver
prefix=../fflib
LIBDIR=$(DESTDIR)${prefix}/lib
SHLIBDIR=$(DESTDIR)${prefix}/lib
INCDIR=$(DESTDIR)../fflib/include
...
CC_IDENT=gcc 4.8 (Ubuntu 4.8.4-2ubuntu1~14.04.4)
ARCH=x86
INTRINSICS=none
EXTERN_PREFIX=
CC=gcc
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600 -DPIC -I$(SRC_PATH)/compat/atomics/gcc -DZLIB_CONST
CFLAGS=   -std=c11 -fomit-frame-pointer -fPIC -pthread -I/usr/include/alsa     -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -Wno-maybe-uninitialized -D_REENTRANT -I/usr/local/include/SDL2
...
CFLAGS-ffplay=-D_REENTRANT -I/usr/local/include/SDL2
...
EXTRALIBS-avcodec=-pthread -lm -llzma -lz
EXTRALIBS-avdevice=-lXv -lX11 -lXext -lm -lxcb -lxcb-shm -lxcb -lxcb-shape -lxcb -lxcb-xfixes -lxcb-render -lxcb-shape -lxcb -lasound -Wl,-rpath,/usr/local/lib -Wl,--enable-new-dtags -L/usr/local/lib -lSDL2
...
EXTRALIBS-ffplay=-Wl,-rpath,/usr/local/lib -Wl,--enable-new-dtags -L/usr/local/lib -lSDL2
EXTRALIBS-ffprobe=
EXTRALIBS-ffmpeg=
